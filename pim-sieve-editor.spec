...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/pim-sieve-editor-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/pim-sieve-editor-25.04.2.tar.xz.sig
...
%setup -q -n pim-sieve-editor-25.04.2
cd %{_builddir}/pim-sieve-editor-25.04.2
pushd ..
cp -a pim-sieve-editor-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749578776
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsieveeditor.so.6.4.2
/usr/lib64/libsieveeditor.so.6
/usr/lib64/libsieveeditor.so.6.4.2
