...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/pim-sieve-editor-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/pim-sieve-editor-22.04.2.tar.xz.sig
...
%prep
%setup -q -n pim-sieve-editor-22.04.2
cd %{_builddir}/pim-sieve-editor-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655141384
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pim-sieve-editor-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/pim-sieve-editor/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/pim-sieve-editor-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/pim-sieve-editor/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/pim-sieve-editor-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/pim-sieve-editor/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/pim-sieve-editor-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/pim-sieve-editor/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/pim-sieve-editor-22.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/pim-sieve-editor/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/pim-sieve-editor-22.04.2/src/org.kde.sieveeditor.desktop.license %{buildroot}/usr/share/package-licenses/pim-sieve-editor/864bc0eb28c73bd997ac19ff91935ab771846615
pushd clr-build
%make_install
popd
...
/usr/lib64/libsieveeditor.so.5.20.2
