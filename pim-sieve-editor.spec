...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/pim-sieve-editor-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/pim-sieve-editor-24.12.3.tar.xz.sig
...
%setup -q -n pim-sieve-editor-24.12.3
cd %{_builddir}/pim-sieve-editor-24.12.3
pushd ..
cp -a pim-sieve-editor-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742516821
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsieveeditor.so.6.3.3
/usr/lib64/libsieveeditor.so.6
/usr/lib64/libsieveeditor.so.6.3.3
