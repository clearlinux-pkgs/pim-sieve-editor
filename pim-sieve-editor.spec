...
Version  : 22.08.0
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.08.0/src/pim-sieve-editor-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/pim-sieve-editor-22.08.0.tar.xz
...
%prep
%setup -q -n pim-sieve-editor-22.08.0
cd %{_builddir}/pim-sieve-editor-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661565334
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libsieveeditor.so.5.21.0
