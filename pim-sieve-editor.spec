...
Version  : 24.05.1
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.05.1/src/pim-sieve-editor-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/pim-sieve-editor-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/pim-sieve-editor-24.05.1.tar.xz.sig
...
%setup -q -n pim-sieve-editor-24.05.1
cd %{_builddir}/pim-sieve-editor-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718592752
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsieveeditor.so.6.1.1
/usr/lib64/libsieveeditor.so.6
/usr/lib64/libsieveeditor.so.6.1.1
