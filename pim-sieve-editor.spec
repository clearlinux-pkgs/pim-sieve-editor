...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/pim-sieve-editor-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/pim-sieve-editor-22.08.1.tar.xz.sig
...
%prep
%setup -q -n pim-sieve-editor-22.08.1
cd %{_builddir}/pim-sieve-editor-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662829299
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libsieveeditor.so.5.21.1
...
/usr/share/package-licenses/pim-sieve-editor/c011fda7746c087a127999da1c4044854ee42238
